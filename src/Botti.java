        ...
        try {
            ...
            while (true) {
                while ((line = lukija.readLine()) != null) {
                    ...
                    else if(parser.protocolMsg(line).equals("ERROR ") && line.contains("ERROR :Closing Link:") || parser.protocolMsg(line).equals("ERROR ") && line.contains("ERROR :Ping timeout") || parser.protocolMsg(line).equals("ERROR ") && line.contains("ERROR :Server going down")){
